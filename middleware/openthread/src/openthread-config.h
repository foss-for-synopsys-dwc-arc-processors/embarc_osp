/* Modified by Qiang Gu for embARC */
...
/* OpenThread examples */
#define OPENTHREAD_EXAMPLES emsk

/* Define to 1 if you want to use emsk examples */
#define OPENTHREAD_EXAMPLES_EMSK 1

/* Define to 1 if you want to use cc2538 examples */
/* #undef OPENTHREAD_EXAMPLES_CC2538 1 */
...
#define PACKAGE_STRING "OPENTHREAD g70e9f76"
...
#define PACKAGE_VERSION "g70e9f76"

/* OpenThread platform information */
#define PLATFORM_INFO "EMSK"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "g70e9f76"
